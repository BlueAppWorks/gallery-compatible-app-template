...
GRANT OPERATE ON COMPUTE POOL <POOL_NAME> TO APPLICATION APP_GALLERY_OPERATOR;
GRANT MONITOR ON COMPUTE POOL <POOL_NAME> TO APPLICATION APP_GALLERY_OPERATOR;
